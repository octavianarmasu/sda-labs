 ...
 */
static void __treap_insert(treap_node_t** node, void* data, int data_size,
                           int (*cmp)(void*, void*)) {
  if (!(*node)) {
 ...
 */
static void __treap_delete(treap_node_t** node, void* data,
 ...
 */
static void* __get_key(treap_node_t* node, void* data,
                       int (*cmp)(void*, void*)) {
  if (!node) {
    return NULL;
  }
 ...
 * @return int Daca arborele e treap, vom returna numarul de noduri al
...
int main() {
  ...
  treap_tree_t* treap =
      treap_create(sizeof(int), (int (*)(void*, void*))(treap_cmp_int));
